var ToDoList = angular.module('ToDoList', ['ngRoute']).controller('ToDoListController',
...
ToDoList.controller('ToDoListController', ['$scope', '$http', function TodoCtrl($scope, $http) {
